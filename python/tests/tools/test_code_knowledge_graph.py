    ...
    entities = [
        {
            ...
            "line_start": 10,
            "language": "java",
            "fully_qualified_name": "com.app.UserService",
            "modifiers": ["public"],
        },
        {
            "name": "getUserName",
            ...
            "line_start": 15,
            "language": "java",
            "fully_qualified_name": "com.app.UserService::getUserName",
            "modifiers": ["public"],
        },
    ]
    relations = [
        {
            "source": "com.app.UserService::getUserName",
            "target": "com.app.UserService",
    ...
    entities = [
        {
            ...
            "line_start": 1,
            "language": "java",
            "fully_qualified_name": "com.Service",
            "modifiers": ["public"],
        },
        {
            "name": "privateHelper",
            ...
            "line_start": 10,
            "language": "java",
            "fully_qualified_name": "com.Service::privateHelper",
            "modifiers": ["private"],
        },
        {
            "name": "Controller",
            ...
            "line_start": 1,
            "language": "java",
            "fully_qualified_name": "com.Controller",
            "modifiers": ["public"],
        },
    ]
    relations = [
        {
            "source": "com.Controller",
            "target": "com.Service::privateHelper",
            "relation_type": "CALLS",
        },
    ]
    result = tool.run(
...
def test_kg_weighted_decay():
    ...
    assert (
        affected.get("com.A", 0) > affected.get("com.B", 0) > affected.get("com.C", 0)
    )

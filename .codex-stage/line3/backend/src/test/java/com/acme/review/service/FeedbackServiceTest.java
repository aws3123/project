...
class FeedbackServiceTest {
    ...
    void setUp() {
        ...
        incidentRecordService = mock(IncidentRecordService.class);
        service = new FeedbackService(feedbackMapper, outboxMapper, new ObjectMapper(), incidentRecordService);
    }
    ...
    void shouldQueueOutboxEventForThumbsDown() {
        ...
        verify(incidentRecordService).createOrRefreshDraft(feedback);
    }
    ...
    void shouldNotQueueOutboxEventForThumbsUp() {
        ...
        verify(incidentRecordService, never()).createOrRefreshDraft(any());
    }
